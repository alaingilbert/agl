...
func (e *Env) loadPkgAgl() {
	...
	e.DefineFn("agl.Set.IsDisjoint", "func [T comparable](s, other agl.Set[T]) bool", WithDesc("Returns a Boolean value that indicates whether the set has no members in common with the given sequence."))
	e.DefineFn("agl.Set.Intersects", "func [T comparable](s, other agl.Set[T]) bool", WithDesc("Returns a Boolean value that indicates whether the set has members in common with the given sequence."))
	...
	e.DefineFn("agl.Option.UnwrapOr", "func [T any](t T) T")
	e.DefineFn("agl.Option.UnwrapOrDefault", "func [T any]() T")
