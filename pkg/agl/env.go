...
func (e *Env) loadPkgAgl(m *PkgVisited) {
	...
	e.withEnv(func(nenv *Env) {
		...
		e.Define(nil, "agl1.DictEntry", types.StructType{Pkg: "agl1", Name: "DictEntry", TypeParams: []types.GenericType{
			types.GenericType{Name: "K", W: types.AnyType{}},
			types.GenericType{Name: "V", W: types.AnyType{}},
		}})
		e.Define(nil, "agl1.DictEntry.Key", types.GenericType{Name: "K", W: types.AnyType{}})
		e.Define(nil, "agl1.DictEntry.Value", types.GenericType{Name: "V", W: types.AnyType{}})
