...
func (e *Env) loadPkgAgl(m *PkgVisited) {
	...
	e.withEnv(func(nenv *Env) {
		...
		e.Define(nil, "IterVec.Clone", types.FuncType{Return: types.InterfaceType{Pkg: "agl1", Name: "CloneIterator", TypeParams: []types.Type{types.GenericType{Name: "T", W: types.AnyType{}}}}})
		...
		e.DefineFn(nenv, "agl1.Set.Iter", "func [T comparable](s agl1.Set[T]) Iterator[T]")
		e.DefineFn(nenv, "agl1.Set.Len", "func [T comparable](s agl1.Set[T]) int", WithDesc("The number of elements in the set."))
		e.DefineFn(nenv, "agl1.Set.Map", "func [T comparable, R any](s agl1.Set[T], f func(T) R) []R")
		...
		e.DefineFn(nenv, "agl1.String.Index", "func (s, substr string) int?")
		...
		e.DefineFn(nenv, "agl1.String.LastIndex", "func (s, substr string) int?")
		...
		e.DefineFn(nenv, "agl1.String.Repeat", "func (s string, count int) string")
		...
		e.DefineFn(nenv, "agl1.String.SplitAfter", "func (s, sep string) []string")
		e.DefineFn(nenv, "agl1.String.Trim", "func (s, cutset string) string")
		e.DefineFn(nenv, "agl1.String.TrimLeft", "func (s, cutset string) string")
		e.DefineFn(nenv, "agl1.String.TrimPrefix", "func (s, prefix string) string")
		e.DefineFn(nenv, "agl1.String.TrimRight", "func (s, cutset string) string")
		...
		e.DefineFn(nenv, "agl1.String.ZFill", "func (s string, width int) string")
		e.DefineFn(nenv, "agl1.Int.Sqrt", "func (int) int")
		e.DefineFn(nenv, "agl1.I8.Sqrt", "func (i8) i8")
		e.DefineFn(nenv, "agl1.I16.Sqrt", "func (i16) i16")
		e.DefineFn(nenv, "agl1.I32.Sqrt", "func (i32) i32")
		e.DefineFn(nenv, "agl1.I64.Sqrt", "func (i64) i64")
		e.DefineFn(nenv, "agl1.Uint.Sqrt", "func (uint) uint")
		e.DefineFn(nenv, "agl1.U8.Sqrt", "func (u8) u8")
		e.DefineFn(nenv, "agl1.U16.Sqrt", "func (u16) u16")
		e.DefineFn(nenv, "agl1.U32.Sqrt", "func (u32) u32")
		e.DefineFn(nenv, "agl1.U64.Sqrt", "func (u64) u64")
		e.DefineFn(nenv, "agl1.F32.Sqrt", "func (f32) f32")
		e.DefineFn(nenv, "agl1.F64.Sqrt", "func (f64) f64")
		e.DefineFn(nenv, "agl1.Int.Abs", "func (int) int")
		e.DefineFn(nenv, "agl1.I8.Abs", "func (i8) i8")
		e.DefineFn(nenv, "agl1.I16.Abs", "func (i16) i16")
		e.DefineFn(nenv, "agl1.I32.Abs", "func (i32) i32")
		e.DefineFn(nenv, "agl1.I64.Abs", "func (i64) i64")
		e.DefineFn(nenv, "agl1.F32.Abs", "func (f32) f32")
		e.DefineFn(nenv, "agl1.F64.Abs", "func (f64) f64")
		e.DefineFn(nenv, "agl1.Int.String", "func (int) string")
		e.DefineFn(nenv, "agl1.I64.String", "func (i64) string")
		e.DefineFn(nenv, "agl1.I32.String", "func (i32) string")
		e.DefineFn(nenv, "agl1.I16.String", "func (i16) string")
		e.DefineFn(nenv, "agl1.I8.String", "func (i8) string")
		e.DefineFn(nenv, "agl1.Uint.String", "func (uint) string")
		e.DefineFn(nenv, "agl1.U8.String", "func (u8) string")
		e.DefineFn(nenv, "agl1.U16.String", "func (u16) string")
		e.DefineFn(nenv, "agl1.U32.String", "func (u32) string")
		e.DefineFn(nenv, "agl1.U64.String", "func (u64) string")
		...
		e.DefineFn(nenv, "agl1.Vec.DropFirst", "func [T any](a []T, k int) []T")
		e.DefineFn(nenv, "agl1.Vec.DropLast", "func [T any](a []T, k int) []T")
		...
		e.DefineFn(nenv, "agl1.Vec.Remove", "func [T any](mut a []T, i int)")
		...
		e.DefineFn(nenv, "agl1.Vec.Swap", "func [T any](mut a []T, b, c Integer)")
		e.DefineFn(nenv, "agl1.Vec.With", "func [T any](mut a []T, i int, clb func(*T))")
		e.DefineFn(nenv, "agl1.Vec.__ADD", "func [T any](a, b []T) []T")
		e.DefineFn(nenv, "agl1.Map.AllSatisfy", "func [K comparable, V any](m map[K]V, f func(DictEntry[K, V]) bool) bool")
		e.DefineFn(nenv, "agl1.Map.ContainsKey", "func [K comparable, V any](m map[K]V, k K) bool")
		e.DefineFn(nenv, "agl1.Map.Drain", "func [K comparable, V any](mut m map[K]V) Iterator[DictEntry[K, V]]")
		...
		e.DefineFn(nenv, "agl1.Map.Insert", "func [K comparable, V any](mut m map[K]V, k K, v V) V?")
		...
		e.DefineFn(nenv, "agl1.Map.Keys", "func [K comparable, V any](m map[K]V) Iterator[K]")
		e.DefineFn(nenv, "agl1.Map.Len", "func [K comparable, V any](m map[K]V) int")
		...
		e.DefineFn(nenv, "agl1.Map.Remove", "func [K comparable, V any](mut m map[K]V, k K) V?", WithDesc("Removes a key from the map, returning the value at the key if the key was previously in the map."))
		e.DefineFn(nenv, "agl1.Map.Values", "func [K comparable, V any](m map[K]V) Iterator[V]")
		...
		e.DefineFn(nenv, "agl1.Iterator.FilterMap", "func [T, R any](s Iterator[T], f func(e T) R?) Iterator[R]")
		...
		e.DefineFn(nenv, "agl1.Iterator.Nth", "func [T any](it Iterator[T], n int) T?")
		e.DefineFn(nenv, "agl1.Iterator.Peekable", "func [T any](it Iterator[T]) *Peekable[T]")
		...
		e.DefineFn(nenv, "agl1.Iterator.Sorted", "func [T cmp.Ordered](s Iterator[T]) []T")
