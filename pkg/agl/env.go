...
func (e *Env) loadPkgAgl(m *PkgVisited) {
	...
	e.withEnv(func(nenv *Env) {
		...
		e.DefineFn(nenv, "agl1.Vec.ReduceInto", "func [T any, R cmp.Ordered](a []T, into: r R, f func(a R, e T)) R", WithDesc("Returns the result of combining the elements of the sequence using the given closure."))
		...
		e.DefineFn(nenv, "agl1.Map.Filter", "func [K comparable, V any](m map[K]V, f func(K, V) bool) map[K]V")
		e.DefineFn(nenv, "agl1.Map.Map", "func [K comparable, V, R any](m map[K]V, f func(K, V) R) []R")
