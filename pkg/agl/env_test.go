...
func Test1(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/net/http", "", make(map[string]struct{}))
...
func Test2(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/fmt", "", make(map[string]struct{}))
...
func Test4(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/io", "", make(map[string]struct{}))
...
func Test5(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/strings", "", make(map[string]struct{}))
