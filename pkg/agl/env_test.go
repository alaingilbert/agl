...
func Test1(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd(0, env, "agl1/net/http", "", NewPkgVisited())
...
func Test2(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd(0, env, "agl1/fmt", "", NewPkgVisited())
...
func Test4(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd(0, env, "agl1/io", "", NewPkgVisited())
...
func Test5(t *testing.T) {
	...
	env.withEnv(func(env *Env) {
		_ = env.loadPkgAglStd(0, env, "agl1/strings", "", NewPkgVisited())
