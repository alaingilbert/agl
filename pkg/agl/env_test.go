...
func Test1(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/net/http", "", NewPkgVisited())
...
func Test2(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/fmt", "", NewPkgVisited())
...
func Test4(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/io", "", NewPkgVisited())
...
func Test5(t *testing.T) {
	env := NewEnv()
	_ = env.loadPkgAglStd("agl1/strings", "", NewPkgVisited())
