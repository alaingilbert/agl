...
func Test1(t *testing.T) {
	...
	_ = env.loadPkgAglStd(0, nil, env, "agl/net/http", "", NewPkgVisited())
...
func Test2(t *testing.T) {
	env := NewEnv(token.NewFileSet())
	_ = env.loadPkgAglStd(0, nil, env, "agl/fmt", "", NewPkgVisited())
...
func Test4(t *testing.T) {
	env := NewEnv(token.NewFileSet())
	_ = env.loadPkgAglStd(0, nil, env, "agl/io", "", NewPkgVisited())
...
func Test5(t *testing.T) {
	...
	env.withEnv(func(env *Env) {
		_ = env.loadPkgAglStd(0, nil, env, "agl/strings", "", NewPkgVisited())
