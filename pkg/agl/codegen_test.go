...
func main() {
	...
	test := NewTest(src, WithMutEnforced(false))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func (set[int]) Intersects(agl.Iterator[int]) bool", test.TypeAt(4, 7).String())
}
...
func (s agl.String) MyLowercased() string {
...
func TestCodeGen365_1(t *testing.T) {
	src := `package main
func main() {
    a := [](u8, (u8, (u8, u8))){(1, (u8(2), (u8(3), u8(4))))}
	a.Map(|(a, (b, (c, d)))| a+b+c+d)
}`
	expected := `// agl:generated
package main
import "fmt"
func main() {
	...
	AglVecMap(a, func(aglArg0 AglTupleStruct_uint8_AglTupleStruct_uint8_AglTupleStruct_uint8_uint8) uint8 {
		a := aglArg0.Arg0
		b := aglArg0.Arg1.Arg0
		c := aglArg0.Arg1.Arg1.Arg0
		d := aglArg0.Arg1.Arg1.Arg1
		return a + b + c + d
	})
}
type AglTupleStruct_uint8_AglTupleStruct_uint8_AglTupleStruct_uint8_uint8 struct {
	Arg0 uint8
...
func main() {
	...
	if AglIteratorAllSatisfy[int](AglNewRange[int](0, 5), func(e int) bool {
		return e < 10
	}) {
	}
	if AglIteratorAllSatisfy[int](AglNewRange[int](0, 5), func(aglArg0 int) bool {
		return aglArg0 < 10
	}) {
	}
	if AglIteratorContains[int](AglNewRange[int](0, 5), 4) {
	}
	AglIteratorForEach[int](AglNewRange[int](0, 5), func(aglArg0 int) AglVoid {
		AglPrint(aglArg0)
		return AglVoid{}
	})
	AglIteratorForEach[int](AglNewRange[int](0, 5), func(e int) AglVoid {
		AglPrint(e)
		return AglVoid{}
	})
	AglIteratorForEach[int](AglNewRange[int](0, 5), func(e int) AglVoid {
...
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func Rev[I agl.DoubleEndedIterator[int]]() *agl.Rev[int]", test.TypeAt(5, 24).String())
...
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func (map[int]u8) Values() agl.Iterator[u8]", test.TypeAt(4, 4).String())
	tassert.Equal(t, "func (agl.Iterator[u8]) Sum() u8", test.TypeAt(4, 13).String())
	tassert.Equal(t, "func (agl.Iterator[u8]) Sum() int", test.TypeAt(5, 13).String())
	testCodeGen2(t, expected, test)
}
...
func TestCodeGen381(t *testing.T) {
	src := `package main
type S struct {
    A (int, int)
}`
...
func TestCodeGen383(t *testing.T) {
	src := `package main
type S struct {
    A (int, int)
}
...
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func (set[int]) Map() []int", test.TypeAt(5, 7).String())
	tassert.Equal(t, "func ([]map[int]int) Reduce(int, func(int, map[int]int) int) int", test.TypeAt(5, 25).String())
	testCodeGen2(t, expected, test)
}
...
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func (map[int]int) Values() agl.Iterator[int]", test.TypeAt(4, 4).String())
	tassert.Equal(t, "func (agl.Iterator[int]) Filter(func(int) bool) agl.Iterator[int]", test.TypeAt(4, 13).String())
	tassert.Equal(t, "func (agl.Iterator[int]) Count() int", test.TypeAt(4, 37).String())
	testCodeGen2(t, expected, test)
}
...
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
	tassert.Equal(t, "func (map[string]int) Keys() agl.Iterator[string]", test.TypeAt(4, 4).String())
	tassert.Equal(t, "func (agl.Iterator[string]) Joined(string) string", test.TypeAt(4, 11).String())
	testCodeGen2(t, expected, test)
}
...
func TestCodeGen417(t *testing.T) {
	src := `package main
type IpAddr enum {
    V4(u8, u8, u8, u8)
    V6(string)
...
func TestCodeGen419(t *testing.T) {
	src := `package main
...
func TestCodeGen420(t *testing.T) {
	src := `package main
...
func TestCodeGen424(t *testing.T) {
	src := `package main
func main() {
	s := set[(u8, u8)]{(1, 1), (1, 2)}
	for e in s {
...
func TestCodeGen427(t *testing.T) {
	src := `package main
type MyEnum enum {
	foo
	bar
...
func TestCodeGen430(t *testing.T) {
	src := `package main
type MyEnum enum {
	foo
	bar
...
func TestCodeGen431(t *testing.T) {
	src := `package main
type MyEnum enum {
	foo
	bar
}
func test(e MyEnum) u8 {
	match e {
	case .foo: u8(1)
	case .bar: u8(2)
	}
...
func TestCodeGen432(t *testing.T) {
	src := `package main
type MyEnum enum {
	foo
	bar
...
func main() {
	e := Make_MyEnum_foo()
	a := []int{1, 2}
	res := AglVecReduce(a, 0, func(res int, el int) int {
		var aglTmp1 int
		if e.Tag == MyEnum_foo {
			aglTmp1 = res + uint8(1)
		} else if e.Tag == MyEnum_bar {
...
func TestCodeGen435(t *testing.T) {
	src := `package main
func main() {
	s := "hello world"
	assert(s.CutPrefix("hello ") == Some("world"))
}`
	expected := `// agl:generated
package main
func main() {
	s := "hello world"
	AglAssert(AglStringCutPrefix(s, "hello ") == MakeOptionSome("world"), "assert failed line 4")
}
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
...
func TestCodeGen438(t *testing.T) {
	src := `package main
func main() {
	s := "hello world"
	print(s.Cut(" ")?.0)
...
func main() {
	s := "hello world"
	AglPrint(AglStringCut(s, " ").Unwrap().Arg0)
}
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
...
func TestCodeGen440(t *testing.T) {
	src := `package main
func main() {
	s := "-"
	assert(s.Repeat(5) == "-----")
...
func main() {
	s := "-"
	AglAssert(AglStringRepeat(s, 5) == "-----", "assert failed line 4")
}
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
...
func TestCodeGen441(t *testing.T) {
	src := `package main
func main() {
	s := "¡¡¡Hello, Gophers!!!"
	assert(s.Trim("!¡") == "Hello, Gophers")
}`
	expected := `// agl:generated
package main
func main() {
	s := "¡¡¡Hello, Gophers!!!"
	AglAssert(AglStringTrim(s, "!¡") == "Hello, Gophers", "assert failed line 4")
}
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
...
func TestCodeGen466(t *testing.T) {
	src := `package main
func test(if: pred func() bool) {
	if pred() {
		print("true")
...
func TestCodeGen469(t *testing.T) {
	src := `package main
type Test[T any] struct {
	C T
}
...
func main() {
	...
	expected := `// agl:generated
package main
type Test_T___int struct {
	C []int
}
func main() {
	AglPrint(New_T___int([]int{1, 2}))
}
func New_T___int(c []int) *Test_T___int {
	return &Test_T___int{C: c}
}
`
	test := NewTest(src, WithMutEnforced(true))
	tassert.Equal(t, 0, len(test.errs))
...
`
	...
	tassert.Equal(t, "func (map[int]int) Keys() agl.Iterator[int]", test.TypeAt(4, 15).String())
	testCodeGen2(t, expected, test)
}
...
package main
func main() {
	var arr []int = AglBuildArray(AglIteratorMap[int, int](AglNewRange[int](0, 10), func(aglArg0 int) int {
		return aglArg0
	}))
	AglPrint(arr)
}
...
package main
func main() {
	dp1 := AglBuildArray(AglIteratorMap[int, int](AglNewRange[int](0, 10), func(aglArg0 int) int {
		return 1
	}))
	var aglTmp1 int
	if dp1[1] != 1 {
	...
	a := AglIdentity(aglTmp1)
	var dp2 []int = AglBuildArray(AglIteratorMap[int, int](AglNewRange[int](0, 10), func(aglArg0 int) int {
		return 1
	}))
	var aglTmp2 int
	if dp2[1] != 1 {
...
func TestCodeGen487(t *testing.T) {
	src := `package main
func main() {
...
package main
func main() {
	it := AglIteratorTake[int](AglNewRange[int](0, 10), 3)
