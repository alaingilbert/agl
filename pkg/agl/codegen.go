...
func (g *Generator) genCallExprSelectorExpr(expr *ast.CallExpr, x *ast.SelectorExpr) GenFrag {
	...
	case types.StringType, types.UntypedStringType:
		...
		case "Split", "SplitAfter", "Cut", "CutPrefix", "CutSuffix", "TrimPrefix", "TrimSuffix", "HasPrefix", "HasSuffix", "Contains", "ContainsAny", "Index", "LastIndex", "Count", "Repeat", "Trim", "TrimLeft", "TrimRight":
			c1 := g.genExpr(x.X)
			c2 := g.genExpr(expr.Args[0])
			return GenFrag{F: func() string {
